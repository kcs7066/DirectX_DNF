...
ACampTwoGameMode::ACampTwoGameMode()
{
	...
	BackGroundRenderer7->SetRelativeLocation({ 40,0,3 });
	...
	BackGroundRenderer5->SetRelativeLocation({ 4,-19,2 });
