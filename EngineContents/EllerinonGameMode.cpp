...
AEllerinonGameMode::AEllerinonGameMode()
{
	...
	BackGroundRenderer0->SetRelativeLocation({ -568,-10,0 });
	...
	BackGroundRenderer1->SetRelativeLocation({ -632,-270,1 });
	...
	BackGroundRenderer2->SetRelativeLocation({ -296,-270,1 });
	...
	BackGroundRenderer3->SetRelativeLocation({ 40,-270,1 });
	...
	BackGroundRenderer4->SetRelativeLocation({ 376,-270,1 });
	...
	BackGroundRenderer5->SetAutoScaleRatio(1.5f);
	BackGroundRenderer5->SetRelativeLocation({ 712,-270,1 });
	BackGroundRenderer5->SetOrder(-100);
	...
	BackGroundRenderer6->SetAutoScaleRatio(1.5f);
	BackGroundRenderer6->SetRelativeLocation({ 1048,-270,1 });
	BackGroundRenderer6->SetOrder(-100);
	...
	BackGroundRenderer13->SetAutoScaleRatio(1.5f);
	BackGroundRenderer13->SetRelativeLocation({ 1048,-450,1 });
	BackGroundRenderer13->SetOrder(-100);
