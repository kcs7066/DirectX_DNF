...
public:
	void OnGUI() override
	{
		...
		{
			std::shared_ptr<ALucille> NewMonster = GetWorld()->SpawnActor<ALucille>();
...
ACampGameMode::ACampGameMode()
{
	...
	//BackGroundRenderer7->SetRelativeLocation({ -380,650,3 });
	...
	BackGroundRenderer1->SetRelativeLocation({ -296,180,1 });
	...
	BackGroundRenderer2->SetRelativeLocation({ 40,180,1 });
	...
	BackGroundRenderer3->SetRelativeLocation({ 376,180,1 });
	...
	BackGroundRenderer4->SetRelativeLocation({ 712,180,1 });
	...
	BackGroundRenderer14->SetWorldLocation({ 106,126,0 });
...
void ACampGameMode::LevelChangeStart()
{
